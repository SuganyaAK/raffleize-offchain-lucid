...
export const lucid = await Lucid.new(new Blockfrost("https://cardano-preview.blockfrost.io/api/v0", "previewL7VRnBQHYkBR9rd6GrKvSzRuCQ7JgTml"), "Preview");
...
export const { paymentCredential } = lucid.utils.getAddressDetails(addr);
